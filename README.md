...
| APPLY SKILLS: read any skill_*.md files and apply relevant ones.                                               | Skill library: apply accumulated reusable techniques before designing.              |                                                                                                                                                                                                                    |
| DEAD ENDS: read FAILED_PATHS.md; never re-try listed approaches; append new failures with reason.              | Negative case memory: eliminate known dead ends from the search space.              | [Wiki: Tabu search](https://en.wikipedia.org/wiki/Tabu_search)                                                                                                                                                     |
...
| WRITE SKILLS: distill a reliable technique into skill_<topic>.md (≤30 lines).                                 | Skill write-back: promote reusable patterns from cases to a persistent skill library. |                                                                                                                                                                                                                   |
